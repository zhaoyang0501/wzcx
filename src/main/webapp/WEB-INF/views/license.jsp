...
<html lang="en"><!--<![endif]--> 
	...
	<body>
			...
			<div class="row">
				<div class="span12">
					...
					<form class="form-inline well">
					 <label class="control-label" for="inputEmail">驾照号码：</label>
					  <input type="text" class="input-small" id='_name' placeholder="驾照号码">
					  <button type="button" class="btn" onclick="$.license.initSearchDataTable()">查询</button>
					</form>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/license.js"></script>
